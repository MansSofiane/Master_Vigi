...
if (isset($_REQUEST['nomag']) && isset($_REQUEST['nomrep']) && isset($_REQUEST['prenomrep']) && isset($_REQUEST['adr'])&& isset($_REQUEST['mail'])&& isset($_REQUEST['tel'])
    ...
    $tel = ($_REQUEST['tel']);
    $mail = ($_REQUEST['mail']);
    $rqt = $bdd->prepare(" INSERT INTO `agence` (`cod_agence`, `lib_agence`, `nom_rep`, `prenom_rep`, `mail`, `adr_agence`, `tel_agence`, `date`,`typ_agence`, `id_user`)  VALUES ('','$nomag','$nomrep','$prenomrep','$mail','$adr','$tel','$datesys','1','$id_user')");
    $rqt->execute();
}
