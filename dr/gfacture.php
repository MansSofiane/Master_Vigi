...
<div id="content-header">
    ...
    <div class="row-fluid">
        ...
        <div class="form-actions" align="right">
            ...
            <input  type="button" class="btn btn-danger"  onClick="dMenu1('com','factures.php')" value="Annuler" />
        </div>
    </div>
    </div>
    ...
    function generer()
    {
        ...
        if(civ!='') {
            ...
            if (!compdat(dat2) || !comp2dat(dat1, dat2)) {
               ...
               xhr.open("GET", "php/validation/genererfact.php?c=" + civ + "&dat1=" + ndat1 + "&dat2=" + ndat2 + "&u=" + user+"&ag2="+ag2+"&cre="+user, false);
                xhr.send(null);
