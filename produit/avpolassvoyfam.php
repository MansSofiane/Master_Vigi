                ...
                <tr class="gradeX">
                    ...
                    <td>&nbsp;
                        ...
                        <?php if ($row_res['mtt_solde']<>0){ ?>
                            <a onClick="reglement('<?php echo $row_res['cod_av'];?>','1','<?php echo $code;//code police?>','avpolassvoyfam.php')" title="Regler"><i CLASS="icon-money icon-2x" style="color:green"  /></a>&nbsp;&nbsp;&nbsp;
                        <?php }?>
                    </td>
                </tr>
            <?php } ?>
...
<script language="JavaScript">
    function frechapconso(){
        ...
        $("#content").load('produit/avpolassvoyfam.php?rech='+rech);
    }
    function fpageapconso(page,nbpage,code){
        if(page >=0){
            if(page == nbpage){
                swal("Information !","Vous ete a la derniere page!","info")
            }else{$("#content").load('produit/avpolassvoyfam.php?page='+page+'&code='+code);}
