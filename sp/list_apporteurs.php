...
<div id="content-header">
    <div id="breadcrumb">  <a class="current1">Apporteurs-Affaires</a><a class="current">Liste-Courtiers</a> </div>
</div>
<div class="widget-box">
    <ul class="quick-actions">
        <li class="bg_lo"> <a onClick="sMenu1('macc','../sdash.php')"> <i class="icon-home"></i>Acceuil </a> </li>
        <li class="bg_lg"> <a onClick="sMenu1('avoy','new_courtier.php')"> <i class="icon-folder-open"></i>Nouveau-Courtier </a> </li>
        <li class="bg_ly"> <a onClick="sMenu1('avoy','list_apporteurs.php')"> <i class="icon-folder-open"></i> Liste Courtiers</a> </li>
        <li class="bg_lb"> <a onClick="list_aport()"> <i class="icon-folder-open"></i> Imprimer</a> </li>

    </ul>
</div>
<div class="widget-box">
    <div class="widget-title">
        <div><input type="text" id="nag" onchange="frechag()" class="span4" placeholder="Rechercher par Raison social..."/></div>
    </div>
    ...
    <div class="widget-title" align="center">
        <h5>Visualisation-Liste-courtiers</h5>
...
<script language="JavaScript">
    function fpageag(page,nbpage){
        if(page >=0){
            ...
            }else{$("#content").load('sp/list_apporteurs.php?page='+page);}
        }else{swal("Information !","Vous ete en premiere page !","info");}
    }

    function frechag(){
        var rech=document.getElementById("nag").value;
        $("#content").load('sp/list_apporteurs.php?rech='+rech);
    }
