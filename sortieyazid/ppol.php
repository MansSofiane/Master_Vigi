...
//Le Réseau
        ...
        $pdf->Cell(20, 5, 'Adresse', '1', '0', 'L', '1');
        $pdf->Cell(75, 5, "" . $row_user['adr_user'] . "", '1', '0', 'C');
        $pdf->Ln();
        $pdf->Cell(40, 5, 'Téléphone', '1', '0', 'L', '1');
        $pdf->Cell(55, 5, "" . $row_user['tel_user'] . "", '1', '0', 'C');
        $pdf->Cell(20, 5, 'E-mail', '1', '0', 'L', '1');
        $pdf->Cell(75, 5, "" . $row_user['mail_user'] . "", '1', '0', 'C');
        $pdf->Ln();
...
// Le Souscripteur
    ...
    $pdf->Cell(20, 5, 'E-mail', '1', '0', 'L', '1');
    $pdf->Cell(75, 5, "" . $row_sous['mail_sous'] . "", '1', '0', 'C');
    $pdf->Ln();
    $pdf->Ln(3);
// L'assuré
    $pdf->SetFillColor(7, 27, 81);
