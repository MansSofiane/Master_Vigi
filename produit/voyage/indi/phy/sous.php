                ...
                if(verifdate1(datnais)) {
                    ...
                    if (verifdate1(datepass)) {date3 = dfrtoen(datepass.value);}
                        if (age >= 18) {
                            if (reponse == 1) {
                                if (!compdat(datepass))
                                {
                                    ...
                                    if (numpass && date3) {
                                        ...
                                        {swal("Erreur","Erreur d'insertion","error");}
                                    } else {
                                        swal("","Le numero du passport est obligatoire","warning");
                                    }
                                } else {swal("Erreur","La date du passport est superiere a la date du jour","error");}
                            ...
                            swal("Attention","Le souscripteur doit avoir plus de 18 ans !","warning");
                        }                    
                }
