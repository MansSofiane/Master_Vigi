...
//boucle pour le style
	...
	$objPHPExcel->getActiveSheet()->setCellValue('T'.$j, $row_g['pt']);
	$objPHPExcel->getActiveSheet()->setCellValue('U'.$j, $row_g['mtt_reg']);
	$objPHPExcel->getActiveSheet()->setCellValue('V'.$j, $row_g['mtt_solde']);
...
//Libelle du type de l'avenant
	...
	$objPHPExcel->getActiveSheet()->setCellValue('T'.$j, $row_v['pt']);
	$objPHPExcel->getActiveSheet()->setCellValue('U'.$j, $row_v['mtt_reg']);
	$objPHPExcel->getActiveSheet()->setCellValue('V'.$j, $row_v['mtt_solde']);
