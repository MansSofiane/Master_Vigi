...
");
        $rqt->execute();
        $rqtav = $bdd->prepare("
SELECT p.cod_pol,''  as avenant,p.cod_prod,p.sequence sequence_police,v.sequence as sequence_av,v.dat_val dat_pol,v.dat_val as dat_avis,v.dat_val as dateavanant,v.dat_eff,v.dat_ech,s.nom_sous,s.pnom_sous,v.mtt_reg,case v.mtt_reg when 0 then  v.mtt_solde-c.mtt_cpl-d.mtt_dt else v.mtt_solde end base_pn_commission,case v.mtt_reg when 0 then  c.mtt_cpl else 0 end mtt_cpl, case v.mtt_reg when 0 then  d.mtt_dt else 0 end mtt_dt
