...
if($type=='5') {
    include "sgenerateurcaisse.php";
}
else {
    include "sgenerateurimpaye.php";
}
    ...
    <ul>
        ...
        for ($index = 0; $index < $i; $index++) {
            if ($test == $row_file[$index]) {
               if($type==5) {?>
                <li><a href="../../../../../../doc/file/excel/<?php echo $test ?>">Mouvement-Caisse-Excel</a></li>
                <?php }
                else
                {?>
                    <li><a href="../../../../../../doc/file/excel/<?php echo $test ?>">Primes-impayees-Excel</a></li>
               <?php }
            }
        }
        } ?>
