   ...
   <ul><input type="hidden" id="datsys" value="<?php echo $datesys; ?>"/>
	...
	<!-- <li id="param" class="submenu"> <a><i class="icon icon-cog"></i> <span>Parametres</span> <span class="label label-important">3</span></a>
      ...
      <ul>
       ...
       <!-- <li><a onClick="Menu1('prod','assccon.php')">&nbsp;&nbsp;&nbsp;&nbsp;ADE-consommation</a></li>-->
		<li><a onClick="dMenu1('prod','polassward.php')">&nbsp;&nbsp;&nbsp;&nbsp;Cancer du Sein Warda</a></li>
          <li><a onClick="dMenu1('prod','polassgroupe.php')">&nbsp;&nbsp;&nbsp;&nbsp;Assurance-Groupe</a></li>
          <li><a onClick="dMenu1('prod','polasspta.php')">&nbsp;&nbsp;&nbsp;&nbsp;Assurance PTA</a></li>
      </ul>
    </li>
	 ...
	 <li id="com" class="submenu" class="submenu" >  <a ><i class="icon icon-user"></i> <span>Commissions</span><span class="label label-important"></span><span class="label label-important">2</span></a>
	   <ul>
        <li><a onClick="dMenu1('com','gfacture.php')">&nbsp;&nbsp;&nbsp;&nbsp;G&eacute;n&eacute;rer une facture</a></li>
        <li><a onClick="dMenu1('com','factures.php')">&nbsp;&nbsp;&nbsp;&nbsp;Factures de commissions</a></li>
      </ul>
	  </li>
       <!--
      ...
      <li id="mged"><a onClick="Menu1('mged','ged.html')"><i class="icon icon-file"></i> <span>Documents</span></a></li>-->
	   ...
	   <ul>
        <li> <a onClick="dMenu1('mstat','stat.php')"><span>Production-PDF</span></a> </li>
           <li> <a onClick="dMenu1('mstat','statcaisse.php')"><span>Caisse-PDF</span></a> </li>
	    <li> <a onClick="dMenu1('mstat','astatex.php')"><span>Production-EXCEL</span></a> </li>
           <li> <a onClick="dMenu1('mstat','statcaissex.php')"><span>Caisse-EXCEL</span></a> </li>
      </ul>
	  </li> 
...
function lav(codepol,page){
    ...
    $("#content").load('dr/'+page+'?code='+codepol);
}
