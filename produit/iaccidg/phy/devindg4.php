...
$jour=$rowper['max_jour'];
    ...
    $rqtnb=$bdd->prepare("SELECT count(cod_sous) as nb FROM `souscripteurw`  WHERE `cod_par`='$codsous' and age<66");
    $rqtnb->execute();
    $nb=0;
    $rabais=1;
...
$pt1=(($cap1*$pe1*$pa1)/100)*$rabais;//capital *taux*reduction selon age*reduction selon le nombre d assures
$tpt1=$tpt1+$pt1;
