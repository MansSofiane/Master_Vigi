...
// Instanciation de la classe derivee
    ...
    /*
        ...
        while ($rwg=$rqtag->fetch())
        {
            ...
            $rqt=$bdd->prepare("select case when  a.sens_avis=0 then 'E' else 'D' end as etatcaisse, p.cod_pol police,'0' as avenant,p.cod_prod,p.sequence sequence_police,'' sequence_av,p.dat_val dat_pol,'' dateavanant,a.id_avis,a.dat_avis,p.dat_eff,p.dat_ech,s.nom_sous,
            ...
            $rqt->execute();
            $rqtav=$bdd->prepare("select case when  a.sens_avis=0 then 'E' else 'D' end as etatcaisse, v.cod_pol police,v.cod_av as avenant,v.cod_prod,p.sequence sequence_police,v.sequence sequence_av,p.dat_val dat_pol ,v.dat_val dateavanant,a.id_avis,a.dat_avis,
        ...
        $rqtavneg=$bdd->prepare("select case when  a.sens_avis=0 then 'E' else 'D' end as etatcaisse, v.cod_pol police,v.cod_av as avenant,v.cod_prod,p.sequence sequence_police,v.sequence sequence_av,p.dat_val dat_pol ,v.dat_val dateavanant,a.id_avis,a.dat_avis,
                                          v.dat_eff,v.dat_ech,s.nom_sous,s.pnom_sous,a.mtt_avis,a.cod_ref,a.cod_av,a.base_pn_commission,a.mtt_cpl,a.mtt_dt,v.lib_mpay,u.agence as source
                                from avis_recette  a, policew as p ,souscripteurw as s,avenantw as v,utilisateurs u
        ...
        $pdf->Cell(240, 10, 'Total Encaissement et Recouverement agence: ' .$agence. '', '1', '0', 'L');
