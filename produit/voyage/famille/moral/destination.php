                    ...
                    if (compdat(dateffet) && compdat(datech)) {
                        if (compare_deux_dates(dateffet, datech))
                        {
                            ...
                            if(nb_jour<=365) {
                                ...
                                if(rp==1){swal("F\351licitation !","Devis Enregistre !", "success"); $("#content").load("produit/assvoyfam.php"); }else{swal('Erreur "," Un ou plusieurs assures ne repondent pas aux criteres de la souscription!!',"error");}
