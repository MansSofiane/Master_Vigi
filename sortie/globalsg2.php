...
// Instanciation de la classe derivee
    $pdf->Cell(380,10,'Etat récapitulatif de la production globale par Agence' ,'','1','C');
    $pdf->Cell(380,10,'Période du:       '.date("d/m/Y", strtotime($date1)).'            au:     '.date("d/m/Y", strtotime($date2)) ,'','1','C');
    if ($agence == '0') {
        $pdf->Cell(210, 10, 'Etat global:Reseau CASH ', '1', '0', 'L');
        $pdf->Cell(180, 10, 'Produit: Tous les produits ', '1', '0', 'L');
        // $pdf->Cell(130, 10, 'Code produit: ', '1', '1', 'C');
    }else
    {
        if($typ_usr=='dr') {
            $pdf->Cell(210, 10, 'Etat global:Direction Regionale N°'.$cas_par_agence, '1', '0', 'L');
            $pdf->Cell(180, 10, 'Produit: Tous les produits ', '1', '0', 'L');
            //$pdf->Cell(130, 10, 'Code produit: ', '1', '1', 'C');
        }else
        {
            $pdf->Cell(210, 10, 'Etat global: Agence N° '.$cas_par_agence, '1', '0', 'L');
            $pdf->Cell(180, 10, 'Produit: Tous les produits ', '1', '0', 'L');
            //$pdf->Cell(130, 10, 'Code produit: ', '1', '1', 'C');
        }
    }
