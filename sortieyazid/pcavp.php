...
// **********************************************
        ...
        while($row_assu=$query_assu->fetch()) {
            ...
            $pdf->Ln();
            if($cod_sous==$row_assu['cod_par'])
            {
                $nom_sous=$row_assu['nom_assu'];
                $pnom_sous=$row_assu['pnom_assu'];
                $adr_sous=$row_assu['adr_assu'];
                $tel_sous=$row_assu['tel_assu'];
                $mail_sous=$row_assu['mail_assu'];
            }
