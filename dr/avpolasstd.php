  ...
  <div class="widget-box">
            <ul class="quick-actions">
			  <li class="bg_lo"> <a onClick="dMenu1('macc','../ddash.php')"> <i class="icon-home"></i>Acceuil </a> </li>
				<li class="bg_lv"> <a onClick="dMenu1('prod','polasstd.php')"> <i class="icon-backward"></i>Precedent</a></li>
...
<script language="JavaScript">
	function frechatd(){
        ...
        $("#content").load('dr/avpolasstd.php?rech='+rech);
	}
	function fpageatd(page,nbpage,code){
		if(page >=0){
			if(page == nbpage){
				swal("Information !","Vous ete a la derniere page!","info")
			}else{$("#content").load('dr/avpolasstd.php?page='+page+'&code='+code);}
