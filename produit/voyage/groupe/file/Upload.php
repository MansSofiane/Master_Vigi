...
class Upload {
	...
	private $_error_messages = array(
		...
		'_check_extension' => "Le format de fichier n'est pas supporté"
	);
	 ...
	 */
 	public function upload($erase_if_exists = false) {
 		...
 		if($file_exists && !$erase_if_exists) {
 			echo "<script type="."'text/JavaScript'"."> alert("."' Vous avez d\351j\340 t\351l\351charg\351 ce fichier!'".");  </script>";
