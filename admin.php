   ...
   <ul><input type="hidden" id="datsys" value="<?php echo $datesys; ?>"/>
      ...
      <ul>
       ...
       <!-- <li><a onClick="Menu1('prod','assccon.php')">&nbsp;&nbsp;&nbsp;&nbsp;ADE-consommation</a></li>-->
		<li><a onClick="aMenu1('prod','assward.php')">&nbsp;&nbsp;&nbsp;&nbsp;Cancer du Sein Warda</a></li>
          <li><a onClick="aMenu1('prod','polassgroupe.php')">&nbsp;&nbsp;&nbsp;&nbsp;Assurance Groupe</a></li>
          <li><a onClick="aMenu1('prod','polasspta.php')">&nbsp;&nbsp;&nbsp;&nbsp;PTA</a></li>
      </ul>
    </li>
       <li id="com" class="submenu" class="submenu" >  <a ><i class="icon icon-user"></i> <span>Commissions</span><span class="label label-important"></span><span class="label label-important">2</span></a>
           <ul>
               <li><a onClick="aMenu1('com','factures.php')">&nbsp;&nbsp;&nbsp;&nbsp;Factures de commissions</a></li>
    ...
    <li id="mged"><a onClick="Menu1('mged','ged.html')"><i class="icon icon-file"></i> <span>Documents</span></a></li>-->
	   ...
	   <ul>
           ...
           <li> <a onClick="aMenu1('mstat','stat.php')"><span>Production-PDF</span></a> </li>
           <li> <a onClick="aMenu1('mstat','statcaisse.php')"><span>Caisse-PDF</span></a> </li>
           <li> <a onClick="aMenu1('mstat','astatex.php')"><span>Production-EXCEL</span></a> </li>
           <li> <a onClick="aMenu1('mstat','statcaissex.php')"><span>Caisse-EXCEL</span></a> </li>
...
function adev(id,page,codedev) {
    ...
    swal({
        ...
        xhr.send(null);
        swal("F\351licitation", "Demande Accord\351e !", "success");
        aMenu1(id, page);
    });
}
 ...
 if (window.XMLHttpRequest) { 
    ...
    swal({
        ...
        if(isConfirm) {
            ...
            xhr.send(null);
            swal("F\351licitation", "Demande rejet\351e !", "success");
            aMenu1(id, page);
        }
