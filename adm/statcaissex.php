...
<div class="row-fluid">
    ...
    <div class="widget-box">
        <ul class="quick-actions">
            ...
            <li class="bg_lv"> <a onClick="aprod('100')"> <i class="icon-bar-chart"></i>Etat-caisse-globale</a></li>
        </ul>
    </div>
        ...
        function aprod(code) {
            ...
            if (verifdatestat(date1) && verifdatestat(date2)) {
                ...
                var d2 = dfrtoenstat(date2.value);
                    ...
                    window.open('excel/SExcelcaisse/' + user + '/' + d1 + '/' + d2+ '/' + code+ '/' + type,"Generation Excel","menubar=no, status=no, scrollbars=yes, menubar=no, width=600, height=230");
