...
<div id="sidebar">
    <ul><input type="hidden" id="datsys" value="<?php echo $datesys; ?>"/>
        <li  id="macc" class="active"><a onClick="mMenu1('macc','../mdash.php')"><i class="icon icon-home"></i> <span>Acceuil</span></a> </li>
        ...
        <li id="prod" class="submenu"> <a><i class="icon icon-th-list"></i> <span>Produits-Assurance</span> <span class="label label-important">1</span></a>
            <ul>
                <li><a onClick="mMenu1('prod','assvoy.php')">&nbsp;&nbsp;&nbsp;&nbsp;Assurance-Voyage</a></li>
        ...
        <li id="mstat" class="submenu" class="submenu" >  <a ><i class="icon icon-signal"></i> <span>Etats-Production</span><span class="label label-important"></span><span class="label label-important">2</span></a>
            <ul>
                ...
                <li> <a onClick="mMenu1('mstat','astatex.php')"><span>Etat-EXCEL</span></a> </li>
            </ul>
        </li>
...
<!--main-container-part-->
<div id="content">
    <script>$("#content").load('mdash.php');</script>
</div>
</body>
</html>
<script type="text/javascript">
    ...
    function mMenu1(id,page) {
        document.getElementById('macc').setAttribute("class", "hover");
        document.getElementById('mstat').setAttribute("class", "hover");
        document.getElementById('prod').setAttribute("class", "hover");
        document.getElementById(id).setAttribute("class", "active");
        $("#content").load('mapfre/'+page);
    }
    function aform(page) {
