...
<div class="widget-box">
    <ul class="quick-actions">
        ...
        <li class="bg_ls"> <a onClick="aMenu1('com','factures.php')"> <i class="icon-folder-open"></i>Factures de commissions</a> </li>
    </ul>
</div>
<div class="widget-box">
...
<script language="JavaScript">
    function frechvcpld(){
        ...
        $("#content").load('adm/factures.php?rech='+rech);
    }
    function fpagegav(page,nbpage){
        if(page >=0){
            if(page == nbpage){
                alert("Vous ete a la derniere page!");
            }else{$("#content").load('adm/factures.php?page='+page);}
