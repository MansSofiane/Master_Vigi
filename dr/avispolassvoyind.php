...
<div class="widget-box">
    <ul class="quick-actions">
        ...
        <li class="bg_lg"> <a onClick="dMenu1('prod','apolvoyind.php')"> <i class="icon-folder-open"></i>Visualiser-Contrats</a> </li>
...
<div class="widget-box">
    ...
    <div class="widget-title" align="center">
        <h5>Visualisation-Avis-recette-Depense-police N: <?php echo $seq;?></h5>
...
<script language="JavaScript">
    /* function frechatd(){
     ...
     $("#content").load('produit/avispolassvoyind.php?rech='+rech);
     }*/
    function fpageatd(page,nbpage,code){
        if(page >=0){
            if(page == nbpage){
                swal("Information !","Vous ete a la derniere page!","info");
            }else{$("#content").load('dr/avispolassvoyind.php?page='+page+'&code='+code);}
