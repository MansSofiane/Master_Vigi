...
// Instanciation de la classe derivee
    ...
    while ($rwg=$rqtag->fetch())
    {
        ...
        if($type==1) {
            //  $lib_type = "ETAT  DES PRIMES ENCAISSEES";
            $rqt=$bdd->prepare("select  p.cod_pol police,'0' as avenant,p.cod_prod,p.sequence sequence_police,'' sequence_av,p.dat_val dat_pol,'' dateavanant,a.id_avis,a.dat_avis,p.dat_eff,p.dat_ech,s.nom_sous,s.pnom_sous,a.mtt_avis,a.cod_ref,a.cod_av,a.base_pn_commission,a.mtt_cpl,a.mtt_dt,u.agence as source
...
,p.mtt_solde  mtt_avis,u.agence as source
...
,v.mtt_solde  mtt_avis,v.lib_mpay,u.agence as source
...
and v.lib_mpay not in ('30','50')");
            ...
            // $lib_type = "ETAT  DES PRIMES RECOUVREES";
            $rqt=$bdd->prepare("select  p.cod_pol police,'0' as avenant,p.cod_prod,p.sequence sequence_police,'' sequence_av,p.dat_val dat_pol,'' dateavanant,a.id_avis,a.dat_avis,p.dat_eff,p.dat_ech,s.nom_sous,s.pnom_sous,a.mtt_avis,a.cod_ref,a.cod_av,a.base_pn_commission,a.mtt_cpl,a.mtt_dt,u.agence as source from avis_recette  a, policew as p ,souscripteurw as s,utilisateurs u
