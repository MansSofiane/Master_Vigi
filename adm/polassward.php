  ...
  <div class="widget-box">
   ...
   <div class="widget-box">
          <div class="widget-title"> 
		   <div><input type="text" id="ansouspwar" onchange="afrechpwar()" class="span4" placeholder="Rechercher par Nom-Souscripteur..."/></div>
          </div>
		 ...
		 <a onClick="alav('<?php echo $row_res['cod_pol'];?>','avpolassward.php')" title="Liste-Avenants"><i CLASS="icon-list-alt icon-2x" style="color:black"/></a>
		  ...
		  <div class="widget-title" align="center">
            <h5>Visualisation-Contrats-Warda</h5>
		     <a href="javascript:;" title="Premiere page" onClick="afpagepwar('0','<?php echo $nbpage; ?>')"><img  src="img/icons/fprec.png"/></a>
			 <a href="javascript:;" title="Precedent" onClick="afpagepwar('<?php echo $page-1; ?>','<?php echo $nbpage; ?>')"><img  src="img/icons/prec.png"/></a>
				  <?php echo $page; ?>/<?php echo $nbpage; ?>
			 <a href="javascript:;" title="Suivant" onClick="afpagepwar('<?php echo $page+1; ?>','<?php echo $nbpage; ?>')"><img  src="img/icons/suiv.png"/></a>
			 <a href="javascript:;" title="Derniere page" onClick="afpagepwar('<?php echo $nbpage-1; ?>','<?php echo $nbpage; ?>')"><img  src="img/icons/fsuiv.png"/></a>
          </div>
        </div>		
