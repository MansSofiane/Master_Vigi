  ...
  <div class="widget-box">
            <ul class="quick-actions">
			  <li class="bg_lo"> <a onClick="dMenu1('macc','../ddash.php')"> <i class="icon-home"></i>Acceuil </a> </li>
				<li class="bg_lv"> <a onClick="dMenu1('prod','polasscim.php')"> <i class="icon-backward"></i>Precedent</a></li>
...
<script language="JavaScript">
	function frechaade(code){
        ...
        $("#content").load('dr/avpolasscim.php?rech='+rech+'&code='+code);
	}
	function fpageaade(page,nbpage,code){
		if(page >=0){
			if(page == nbpage){
				swal("Information !","Vous ete a la derniere page!","info");
			}else{$("#content").load('dr/avpolasscim.php?page='+page+'&code='+code);}
