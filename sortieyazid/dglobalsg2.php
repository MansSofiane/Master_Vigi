...
// Instanciation de la classe derivee
    ...
    if ($agence == '0') {
        ...
        $pdf->Cell(180, 10, 'Produit: Tous les produits ', '1', '0', 'C');
    ...
    $pdf->Cell(40,10,'Produits','1','0','C');$pdf->Cell(50,10,'Production','1','0','C'); $pdf->Cell(20,10,'Nombre','1','0','C');$pdf->Cell(60,10,'P.Nette','1','0','C');$pdf->Cell(40,10,'Accessoire','1','0','C');$pdf->Cell(60,10,'P.Commer','1','0','C');$pdf->Cell(40,10,'D.T','1','0','C');$pdf->Cell(80,10,'P.Total','1','0','C');
    //$pdf->Cell(50,10,'Encaissement/Décaissement','1','0','C');$pdf->Cell(30,10,'Solde (+)','1','0','C');$pdf->Cell(30,10,'Solde (-)','1','0','C');
    $pdf->Ln();
...
group by table1.cod_prod");
            ...
            $rqt_s_rist = $bdd->prepare("select count(cod_doc) as nb, sum(prime_nette) as prime_nette, sum(cout_police) as cout_police,sum(prime_com)as prime_com, sum(droit_timbre) as droit_timbre, sum(prime_totale) as prime_totale,sum(reglement) as Reglement,sum(solden) as Solden,table1.agence as agence,table1.cod_prod,table1.produits as produits
from (
...
group by table1.cod_prod");
        ...
        while($rows_ar_pi=$rqtrist->fetch())
        {
           ...
           // $reglement_total_ar_pi=-$rows_ar_pi['Reglement'];// EN NEGATIF CAR C EST UN AVENANT AVEC RISTOURNE
        ...
        while($rows_sr_pi=$rqt_s_rist->fetch())
        {
          ...
          //  $reglement_total_sr_pi=-$rows_sr_pi['Reglement'];//EN NEGATIF
      ...
      //  $pdf->Cell(50,7,''.number_format($reglement_total_positif_pi, 2,',',' ').'','1','0','R');
       // $pdf->Cell(30,7,''.number_format($solde_total_positif_pi, 2,',',' ').'','1','0','R');
      //  $pdf->Cell(30,7,''.number_format($solde_total_positif_pi2, 2,',',' ').'','1','0','R');
       ...
       // $pdf->Cell(30,7,''.number_format($solde_total_ar_pi, 2,',',' ').'','1','0','R');
       // $pdf->Cell(30,7,''.number_format($solde_total_ar_pi2, 2,',',' ').'','1','0','R');
       // $pdf->Cell(50,7,'','1','0','R');
       // $pdf->Cell(40,7,'','1','0','R');
     ...
     //   $pdf->Cell(50,7,''.number_format($reglement_total_sr_pi, 2,',',' ').'','1','0','R');
      //  $pdf->Cell(30,7,''.number_format($solde_total_sr_pi, 2,',',' ').'','1','0','R');
      //  $pdf->Cell(30,7,''.number_format($solde_total_sr_pi2, 2,',',' ').'','1','0','R');
       // $pdf->Cell(50,7,'','1','0','R');
       // $pdf->Cell(40,7,'','1','0','R');
      ...
      //  $pdf->Cell(30,7,''.number_format($solde_total_pi, 2,',',' ').'','1','0','R');
      //  $pdf->Cell(30,7,''.number_format($solde_total_pi2, 2,',',' ').'','1','0','R');
       // $pdf->Cell(50,7,'','1','0','R');
       // $pdf->Cell(40,7,'','1','0','R');
   ...
   // $pdf->Cell(30,10,''.number_format($solde_total, 2,',',' ').'','1','0','R');
  //  $pdf->Cell(30,10,''.number_format($solde_total2, 2,',',' ').'','1','0','R');
