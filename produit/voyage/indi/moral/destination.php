                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <select id="opt" onchange="hadjetomra(this)">
                                ...
                                <?php
                                if($agence=="d0301" || $agence="d0302") {
                                    $rqtopt = $bdd->prepare("SELECT * FROM `option` WHERE cod_opt = '22' OR cod_opt='26' OR cod_opt='13' OR cod_opt >= '30'");//OR cod_opt ='25'
                                    //$res_rqtop=mysql_query($rqtop) or die ($rqtop . "-----" . mysql_error());
                                    $rqtopt->execute();
                                }
                                else
                    ...
                    if (compdat(dateffet) && compdat(datech)) {
                        if (compare_deux_dates(dateffet, datech)) {
                            ...
                            if(nb_jour<=365)
                            {
                                ...
                                if(rp==1){swal("F\351licitation !","Devis Enregistre !", "success"); $("#content").load("produit/assvoyind.php");
                                }else{swal('Erreur "," Un ou plusieurs assures ne repondent pas aux criteres de la souscription!!',"error");}
