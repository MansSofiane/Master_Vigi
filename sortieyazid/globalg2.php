...
// Instanciation de la classe derivee
    ...
    $pdf->Cell(40,10,'Produits','1','0','C');$pdf->Cell(50,10,'Production','1','0','C'); $pdf->Cell(20,10,'Nombre','1','0','C');$pdf->Cell(40,10,'P.Nette','1','0','C');$pdf->Cell(30,10,'Accessoire','1','0','C');$pdf->Cell(40,10,'P.Commer','1','0','C');$pdf->Cell(20,10,'D.T','1','0','C');$pdf->Cell(50,10,'P.Total','1','0','C');$pdf->Cell(50,10,'Encaissement/Décaissement','1','0','C');$pdf->Cell(40,10,'Solde (+)','1','0','C');$pdf->Cell(40,10,'Solde (-)','1','0','C');    $pdf->Ln();
...
group by table1.cod_prod");
       ...
       $reglement_total_pi=$reglement_total_positif_pi+$reglement_total_ar_pi+$reglement_total_sr_pi;
        ...
        $pdf->Cell(50,7,'','1','0','R');
        $pdf->Cell(40,7,'','1','0','R');$pdf->Ln(7);
        $pdf->Cell(50,7,''.number_format($reglement_total_positif_pi, 2,',',' ').'','1','0','R');
        $pdf->Cell(40,7,''.number_format($solde_total_positif_pi, 2,',',' ').'','1','0','R');
        $pdf->Cell(40,7,''.number_format($solde_total_positif_pi2, 2,',',' ').'','1','0','R');$pdf->Ln(7);
        $X=$pdf->GetX();
        $pdf->SetX($X+40);
        ...
        $pdf->Cell(40,7,''.number_format($solde_total_ar_pi2, 2,',',' ').'','1','0','R');
        ...
        $pdf->Cell(40,7,''.number_format($solde_total_sr_pi2, 2,',',' ').'','1','0','R');
        ...
        $pdf->Cell(40,7,''.number_format($solde_total_pi2, 2,',',' ').'','1','0','R');
    ...
    $pdf->Cell(40,10,''.number_format($solde_total2, 2,',',' ').'','1','0','R');
