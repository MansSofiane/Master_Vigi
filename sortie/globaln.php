...
$rqtp->execute();
$agence="";
	$pdf->Cell(405,10,'Bordereau de production négatif avec Ristourne du '.date("d/m/Y", strtotime($date1)).' au '.date("d/m/Y", strtotime($date2)).'  --Document généré le-- '.date("d/m/Y", strtotime($datesys)) ,'1','1','L','1');
