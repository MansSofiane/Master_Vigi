...
<div class="widget-box">
    <ul class="quick-actions">
        ...
        <li class="bg_lg"> <a onClick="dMenu1('prod','apolassvoyfam.php')"> <i class="icon-folder-open"></i>Visualiser-Contrats</a> </li>
...
<script language="JavaScript">
    function frechatd(){
        ...
        $("#content").load('dr/avispolassvoyfam.php?rech='+rech);
    }
    function fpageatd(page,nbpage,code){
        if(page >=0){
            if(page == nbpage){
                swal("Information !","Vous ete a la derniere page!","info");
            }else{$("#content").load('dr/avispolassvoyfam.php?page='+page+'&code='+code);}
