...
$rqtg=$bdd->prepare("SELECT count(cod_pol) as totalc FROM `policew` as p, `souscripteurw` as s, `produit` as r WHERE p.cod_sous=s.cod_sous and p.cod_prod=r.cod_prod and r.cod_prod='9'");
   ...
   <div id="content-header">
    ...
    <div class="widget-box">
            ...
            <ul class="quick-actions">
			  ...
			  <li class="bg_lw"> <a onClick="sMenu1('prod','polassward.php')"> <i class="icon-folder-open"></i>C-S-Warda</a> </li>
